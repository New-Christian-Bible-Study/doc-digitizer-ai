...
from transcribe_integration_helpers import (
    ...
    assert_common_ai_summary_fields,
...
TEST_1_AI_SUMMARY_PATH = WORKING_DIR / 'transcriptions' / 'test-a_001-003_summary.md'
...
def test_live_integration_test_1_transcribes_and_logs():
    ...
    if TEST_1_AI_SUMMARY_PATH.exists():
        TEST_1_AI_SUMMARY_PATH.unlink()
    ...
    assert TEST_1_AI_SUMMARY_PATH.exists()
