...
For the **prompt-based** flow, see [`prompt-based/README.md`](../prompt-based/README.md): run `generate-chunk.py` (or equivalent) with `--working-dir` set to a directory that contains `source-pdfs/` where you placed the file.
